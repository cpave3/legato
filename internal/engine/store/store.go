...
func (s *Store) migrate() error {
	...
	migrations := []string{"001_init.sql", "002_stale_and_move_tracking.sql", "003_rename_jira_to_remote.sql", "004_agent_sessions.sql", "005_tasks.sql", "006_agent_activity.sql", "007_state_intervals.sql", "008_workspaces.sql", "009_archive.sql", "010_pr_meta.sql", "011_ephemeral.sql", "012_swarm.sql", "013_agent_role.sql", "014_swarm_v1.sql", "015_swarm_events.sql", "016_state_interval_working_dir.sql"}
