	...
	return []store.Ticket{
		{
			...
			Status: "Done", RemoteStatus: "Done", Priority: "High", IssueType: "Task",
			...
			RemoteUpdatedAt: now, SortOrder: 0,
		},
		{
			...
			Status: "Done", RemoteStatus: "Done", Priority: "High", IssueType: "Story",
			...
			RemoteUpdatedAt: now, SortOrder: 1,
		},
		{
			...
			Status: "In Progress", RemoteStatus: "In Progress", Priority: "High", IssueType: "Story",
		...
		},
		{
			...
			Status: "In Progress", RemoteStatus: "In Progress", Priority: "Medium", IssueType: "Task",
		...
		},
		{
			...
			Description: "",
			DescriptionMD: "",
			Status: "Backlog", RemoteStatus: "To Do", Priority: "High", IssueType: "Epic",
		...
		},
		{
			...
			Status: "Backlog", RemoteStatus: "Open", Priority: "Medium", IssueType: "Story",
		...
		},
		{
			...
			Status: "In Review", RemoteStatus: "In Review", Priority: "Low", IssueType: "Task",
		...
		},
		{
			...
			RemoteUpdatedAt: now, SortOrder: 2,
		},
		{
			...
			Status: "Backlog", RemoteStatus: "To Do", Priority: "Low", IssueType: "Story",
			...
			RemoteUpdatedAt: now, SortOrder: 3,
		},
		{
			...
			Status: "Backlog", RemoteStatus: "Open", Priority: "Low", IssueType: "Spike",
			...
			RemoteUpdatedAt: now, SortOrder: 4,
		},
	}
}
